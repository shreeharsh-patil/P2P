    ...
    <div className="tech-panel p-5 bg-[#09090b] border border-[#1c1c22] space-y-4 font-mono">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          placeholder={isConnected ? 'Type a message...' : 'Awaiting peer connection'}
        ...
        <button
          ...
          className="px-4 py-2 bg-[#ff2b2b] hover:bg-[#e51b23] disabled:opacity-40 text-white rounded-sm font-mono font-bold text-xs flex items-center gap-1.5 transition-colors uppercase tracking-wider"
        >
